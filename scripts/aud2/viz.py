...
deg_loc = base_loc + "aud2_degs.csv"
vsd_loc = base_loc + "aud2_vsd.csv"
metadata_loc = "/lustre/research/dawli/stexocaelum/aud2/metadata.csv"
viz_loc = base_loc + "aud2_viz.png"
raw_loc = "/lustre/research/dawli/stexocaelum/aud2/counts.csv"
...
fig = make_subplots(rows=3, cols=4, 
    subplot_titles=("PCA of top 10 TEs based on adjusted <i>P</i>-value", "Volcano plot", te_names[0], te_names[1], te_names[2], te_names[3]),
...
fig.add_vline(x=-1, line_dash="dash", line_color="#777777", row=1, col=3)
fig.add_hline(y=np.log10(8e-8)*-1, line_dash="dash", line_color="#777777", row=1, col=3)
...
for i in range(0,4):
    ...
    fig.add_trace(go.Box(y=viz_case, jitter=0.5, boxpoints="all", marker={"color" : colors[0]}, name="AUD"), row=3, col=i+1)
...
fig.add_annotation(text="Alcohol Use Disorder", xref="paper", yref="paper", x=.141, y= 1.065, showarrow=False, font=dict(size=14))
