...
deg_loc = base_loc + "me_degs.csv"
vsd_loc = base_loc + "me_vsd.csv"
metadata_loc = "/lustre/research/dawli/stexocaelum/manu_me_cfs/metadata.csv"
viz_loc = base_loc + "me_viz.png"
raw_loc = "/lustre/research/dawli/stexocaelum/manu_me_cfs/counts.csv"
...
print(deg_df[(abs(deg_df["log2FoldChange"]) >= 1) & (deg_df["pvalue"] <= 1)])
...
fig.add_annotation(text="ME/CFS", xref="paper", yref="paper", x=.141, y= 1.08, showarrow=False, font=dict(size=14))
